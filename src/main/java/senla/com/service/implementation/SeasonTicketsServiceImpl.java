...
public class SeasonTicketsServiceImpl implements SeasonTicketsService {
    ...
    private final SeasonTicketsRepository seasonTicketsRepository;
    private final GenericMapper genericMapper;

    @Override
    public SeasonTicketsDto findById(Long id) {
        return genericMapper.convertToDto(seasonTicketsRepository.findById(id), SeasonTicketsDto.class);
    }
